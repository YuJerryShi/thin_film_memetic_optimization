function [R_TE] = reflection_disp_TE(n_in, n_out, n_disp, d, lambda, theta_in)
%REFLECTION_DISP_TE Calculates the oblique TE reflection spectrum of a multi-layer structure
%   R_TE: reflection spectrum
% 
